...
def process_video(input_video_path, output_video_path):
    ...
    while True:
        ...
        cv2.putText(frame, f'Passengers detected: {current_count}', (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
    ...
    cap.release()
    out.release()
    print(f"Finished processing the video. Saved output to {output_video_path}")

if __name__ == '__main__':
    process_video('./backend/face_counter/bus.mp4', './results.mp4')
